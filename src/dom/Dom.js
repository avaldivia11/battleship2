import { createDiv, createElem } from './Elmcreators';

function boats() {
  const rightCol = createDiv(['col-1']);
...
function createButtons() {
  ...
  const startBtn = createElem('button', '', ['btn', 'btn-primary', 'justify-content-center']);
